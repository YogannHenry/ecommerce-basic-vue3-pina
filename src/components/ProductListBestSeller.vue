    ...
    <section class="text-gray-600 body-font overflow-hidden ">
        <div class="container px-5 py-24 mx-auto intersection mb-32 ">
            <div class="lg:w-4/5 mx-auto flex flex-wrap justify-evenly  rounded-lg shadow-3xl bg-c1" data-color="rgb(184 61 52 )">
                ...
                <img alt="ecommerce" class="w-80 object-cover rounded p-5 " :src="productFilterBestSeller[0].productPicture">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    <h2 class="text-sm title-font text-slate-50 tracking-widest">{{ productFilterBestSeller[0].productEAN }}</h2>
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{{ productFilterBestSeller[0].productName }}</h1>
                    <div class="flex mb-4">
