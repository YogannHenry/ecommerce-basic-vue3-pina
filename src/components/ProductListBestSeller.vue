<template>
   ...
   <section class="text-gray-600 body-font overflow-hidden ">
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap justify-evenly  rounded-lg shadow-2xl ">

                <img alt="ecommerce" class="w-80 object-cover rounded  "
                    :src="product.productPicture">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    <h2 class="text-sm title-font text-gray-500 tracking-widest">{{ product.productEAN }}</h2>
